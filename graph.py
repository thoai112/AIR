...
class Graph():
    ...
    def _update_edges(self):
        ...
        for i in range(self.edge_index.shape[1]):
            ...
            src_lat, src_lon = self.nodes[src]['lat'], self.nodes[src]['lon']
            dest_lat, dest_lon = self.nodes[dest]['lat'], self.nodes[dest]['lon']
            src_x, src_y = self._lonlat2xy(src_lon, src_lat, False)
            dest_x, dest_y = self._lonlat2xy(dest_lon, dest_lat, False)
